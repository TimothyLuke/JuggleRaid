...
local function groupCompOnTooltipShow(tooltip)
  ...
  if IsInGroup() then
    ...
    tooltip:AddDoubleLine(
      format("%s (%s):", L["phrase.groupComp"], (IsInRaid() and L["word.raid"] or L["word.party"])),
      A.util:FormatGroupComp(A.util.GROUP_COMP_STYLE.TEXT_SHORT, t, h, m, r, u),
      1,
      1,
      0,
      1,
    ...
    tooltip:AddDoubleLine(
      A.util:GetRoleIcon("DAMAGER") .. " " .. L["word.damager.plural"],
      tostring(m + r + u),
      1,
      1,
      1,
    ...
    tooltip:AddDoubleLine(
      A.util:BlankInline(8, A.options.roleIconSize) .. " " .. L["word.total"],
      tostring(t + h + m + r + u),
      1,
      1,
      1,
    ...
    if sitting > 0 then
      tooltip:AddLine(" ")
      tooltip:AddDoubleLine(
        format(L["dataBroker.groupComp.sitting"], A.util:GetSittingGroupList()),
        HD(tostring(sitting)),
        1,
        1,
        1,
  ...
  tooltip:AddLine(" ")
  tooltip:AddDoubleLine(
    format("%s:", L["phrase.mouse.clickLeft"]),
  ...
  tooltip:AddDoubleLine(
    format("%s:", L["phrase.mouse.clickRight"]),
    format(L["dataBroker.groupComp.toggleAddonWindow"], A.NAME),
    1,
    1,
    1,
    1,
  ...
  tooltip:AddDoubleLine(
    format("%s:", L["phrase.mouse.shiftClickLeft"]),
  ...
  tooltip:AddDoubleLine(
    format("%s:", L["phrase.mouse.shiftClickRight"]),
